from mistify.infer import _activate as activations
...
class TestDescale:
    ...
    def test_descale_produces_an_output_between_zero_and_one(self):
        ...
        descale = activations.DescaleAct(0.2)
        m = torch.rand(6, 8)
        descaled = descale(m)
...
class TestSigmoid:
    ...
    def test_sigmoid_produces_an_output_between_zero_and_one(self):
        ...
        sigmoidal = activations.SigmoidalAct(8)
        m = torch.rand(6, 8)
    ...
    def test_sigmoid_produces_an_output_between_zero_and_one_with_two_vars(self):
        ...
        sigmoidal = activations.SigmoidalAct(8, n_vars=2)
        m = torch.rand(6, 2, 8)
        activated = sigmoidal(m)
        assert ((0 <= activated) & (activated <= 1.0)).all()
    ...
    def test_sigmoid_produces_an_output_between_zero_and_one_with_none_vars(self):
        ...
        sigmoidal = activations.SigmoidalAct(8, n_vars=None)
        m = torch.rand(6, 2, 8)
        activated = sigmoidal(m)
        assert ((0 <= activated) & (activated <= 1.0)).all()
...
class TestTriangular:
    ...
    def test_trianglar_produces_an_output_between_zero_and_one(self):
        ...
        triangular = activations.TriangularAct(8)
        m = torch.rand(6, 8)
    ...
    def test_trianglar_produces_an_output_between_zero_and_one_with_two_vars(self):
        ...
        triangular = activations.TriangularAct(8, n_vars=2)
        m = torch.rand(6, 2, 8)
        activated = triangular(m)
        assert ((0 <= activated) & (activated <= 1.0)).all()
...
class TestHedge:
    ...
    def test_hedge_produces_an_output_between_zero_and_one_with_two_vars(self):
        ...
        hedge = activations.HedgeAct(8, n_vars=2)
        m = torch.rand(6, 2, 8)
        activated = hedge(m)
        assert ((0 <= activated) & (activated <= 1.0)).all()
    ...
    def test_hedge_produces_an_output_between_zero_and_one_with_none_vars(self):
        ...
        hedge = activations.HedgeAct(8, n_vars=None)
        m = torch.rand(6, 2, 8)
        activated = hedge(m)
        assert ((0 <= activated) & (activated <= 1.0)).all()
    ...
    def test_hedge_produces_an_output_between_zero_and_one_with_lower_bound(self):
        ...
        hedge = activations.HedgeAct(8, n_vars=None, lower_bound=0.8, upper_bound=1.2)
        m = torch.rand(6, 2, 8)
        activated = hedge(m)
        assert ((0 <= activated) & (activated <= 1.0)).all()
